    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container px-4 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-8 text-sm text-gray-600">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5">
            ...
            {data.personalInfo.phone && (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 hover:bg-primary/10 transition-colors"
              >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-primary text-white px-8 py-3 text-sm font-medium shadow-md hover:bg-primary/90 transition-colors"
            >
              Get in Touch
            </button>
          </div>
